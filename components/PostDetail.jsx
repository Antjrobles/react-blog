...
const PostDetail = ({ post }) => {
  const getContentFragment = (index, text, obj, type) => {
    ...
    switch (type) {
      case 'heading-three':
        return <h3 key={index} className="text-xl font-semibold mb-4 text-center">{modifiedText.map((item, i) => <React.Fragment key={i}>{item}</React.Fragment>)}</h3>;
      case 'paragraph':
  ...
  return (
    <>
      <div className="shadow-2xl rounded-lg lg:p-8 pb-12 mb-8">
